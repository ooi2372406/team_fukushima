...
<main style="height:100vh;">
  ...
  <div style="width: 100%;text-align: center; background-color:seagreen; padding:10px 20px 10px 20px; margin-bottom:100px;">コメントを削除しました</div>

	<div class="d-flex flex-row bd-highlight mb-3">

  		<div><a href="StudentList.action">学生分析</a></div>
  	</div>
  </div>
