...
<main>
    <div class="kamokucontainer-create">
        ...
        <form id="studentForm" action="TestListStudentExecute.action" method="post">
            <div style="border:1px solid whitesmoke; height:120px;">
            ...
            <div style="margin: 10px 0 0 20px;">
                <label><p style="color:#03fcf8">科目情報を選択または学生情報を入力して検索ボタンをクリックしてください</p></label>
            </div>
        </form>
        <div id="results"></div> <!-- Area to display results -->
    </div>
</main>
...
$(document).ready(function() {
    $('#subjectForm, #studentForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        $.ajax({
