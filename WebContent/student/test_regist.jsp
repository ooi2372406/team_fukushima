                    ...
                    <div style="display:flex; display: -webkit-flex; align-items: center; height:90px; margin-top:10px;">
                        ...
                        <table class="responsive-table-seiseki" style="width:100%; margin-top:auto;">
                            <tr>
                                ...
                                <td rowspan="2" style="text-align:center;"><button class="btn btn-primary" type="submit" value="検索" style="padding:10px 25px; border: none;background-color: #666666;">検索</button></td>
                            </tr>
                            <tr>
                                <!-- 入学年度の選択 -->
                                <td>
